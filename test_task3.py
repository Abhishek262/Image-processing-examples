...
def process(ip_image):
    ...
    center_pixel_coords = []
    my = ip_image.shape[0]//2 - ip_image.shape[0]//8
    ny = ip_image.shape[0]//2 + ip_image.shape[0]//8
    
    mx  = ip_image.shape[1]//2 - ip_image.shape[1]//8
    nx = ip_image.shape[1]//2 + ip_image.shape[1]//8
    ...
    for i in range(0,ip_image.shape[0]):
        for j in range(0,ip_image.shape[1]):
            ...
            if ip_image[i,j][1]>180 and ip_image[i,j][2]>125 and ip_image[i,j][2]<155 and ip_image[i,j][0]<70 and ip_image[i,j][1]<230:
